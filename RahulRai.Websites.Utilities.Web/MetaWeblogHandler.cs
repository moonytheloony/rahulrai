...
namespace RahulRai.Websites.Utilities.Web
{
    ...
    using RahulRai.Websites.Utilities.AzureStorage.Search;
    ...
    public sealed class MetaWeblogHandler : XmlRpcService, IMetaWeblog, IDisposable
    {
        ...
        private readonly string queueName =
            WebConfigurationManager.AppSettings[ApplicationConstants.NewBlogPostQueueName];
        ...
        /// <exception cref="BlogSystemException">
        /// delete failed
        /// or
        ...
        /// <returns>System.Object[].</returns>
        /// <exception cref="BlogSystemException">error getting recent posts</exception>
        object[] IMetaWeblog.GetRecentPosts(string blogid, string username, string password, int numberOfPosts)
        {
            ...
            try
            {
                ...
                var query = (from record in activeTable.CreateQuery<DynamicTableEntity>()
                             where
                                 record.PartitionKey == ApplicationConstants.BlogKey
                                     ...
                                     && string.Compare(record.RowKey, rowKeyToUse, StringComparison.OrdinalIgnoreCase)
                                         > 0
                ...
                var blogEntity =
                    result.Select(element => element.ConvertDynamicEntityToEntity<TableBlogEntity>())
        ...
        /// <param name="password">The password.</param>
        /// <returns>System.Object[].</returns>
        /// <exception cref="BlogSystemException">Getting user blogs</exception>
        ...
        /// <returns>System.Object.</returns>
        /// <exception cref="BlogSystemException">error adding image to blog</exception>
